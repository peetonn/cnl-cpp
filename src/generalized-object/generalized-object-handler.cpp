...
GeneralizedObjectHandler::Impl::setObject
  (Namespace& nameSpace, const Blob& object, const string& contentType, const Blob& other)
{
  bool hasSegments =
    (object.size() > segmentedObjectHandler_->getMaxSegmentPayloadLength()) || other.size() > 0;
